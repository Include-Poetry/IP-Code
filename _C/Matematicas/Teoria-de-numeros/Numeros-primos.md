...
Con la criba de primos también podemos decir si un número más grande que el rango de la criba es primo, esto lo haríamos como se dijo antes, revisando si el número a evaluar puede ser dividido por los números de la criba. Si el número primo más grande generado por la criba es $$P$$ entonces este método descrito solamente alcanzaría para evaluar número $$N$$ donde $$N \leq P^2$$.